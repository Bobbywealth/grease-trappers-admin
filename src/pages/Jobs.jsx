    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="card p-4 mb-6 flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-pink"
        >
                ...
                {jobs.map(j => (
                  <tr key={j.id} className="hover:bg-gray-50">
                    <td className="px-4 py-3">
                      <Link to={`/jobs/${j.id}`} className="font-medium text-gray-900 hover:text-brand-pink">
