            ...
            <div key={c.id} className="card p-5 hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between mb-3">
                <Link to={`/customers/${c.id}`} className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-900 truncate hover:text-brand-pink">
                    {c.business_name}
                  </h3>
                  {c.contact_name && (
              ...
              <div className="space-y-1.5 text-sm">
                ...
                {c.phone && (
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <a href={`tel:${c.phone}`} className="hover:text-brand-pink">{c.phone}</a>
                  </div>
                )}
                {c.email && (
                  <div className="flex items-center gap-2 text-gray-600">
                    <Mail className="w-3.5 h-3.5 flex-shrink-0" />
                    <a href={`mailto:${c.email}`} className="hover:text-brand-pink truncate">{c.email}</a>
                  </div>
                )}
              </div>
