          ...
          {users.map(u => (
            <div key={u.id} className="card p-5">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-pink to-pink-400 flex items-center justify-center text-white font-semibold flex-shrink-0">
                ...
                <button
                  onClick={() => openEdit(u)}
                  className="p-1.5 text-gray-400 hover:text-brand-pink hover:bg-pink-50 rounded"
                >
              ...
              <div className="space-y-1.5 text-sm">
                ...
                {u.phone && (
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <a href={`tel:${u.phone}`} className="hover:text-brand-pink">{u.phone}</a>
                  </div>
                )}
                {u.last_login_at && (
