    ...
    <div className="p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
          ...
          {customer.phone && (
            <div className="flex items-center gap-2">
              ...
              <a href={`tel:${customer.phone}`} className="hover:text-brand-pink">{customer.phone}</a>
            </div>
          )}
          {customer.email && (
            <div className="flex items-center gap-2">
              <Mail className="w-4 h-4 text-gray-400" />
              <a href={`mailto:${customer.email}`} className="hover:text-brand-pink truncate">{customer.email}</a>
            </div>
          )}
          <div className="flex items-center gap-2">
          ...
          <div className="divide-y divide-gray-100">
            {customer.traps.map((t) => (
              <div key={t.id} className="p-4 flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-pink-50 text-brand-pink flex items-center justify-center flex-shrink-0">
                ...
                <button onClick={() => openEditTrap(t)} className="p-1.5 text-gray-400 hover:text-brand-pink hover:bg-pink-50 rounded">
      ...
      <div className="card mb-6">
        <div className="flex items-center justify-between p-5 border-b border-gray-200">
          ...
          <Link to="/jobs" className="text-sm text-brand-pink hover:underline">View all jobs</Link>
        </div>
